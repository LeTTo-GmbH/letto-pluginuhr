...
public class ResponseTools {
         ...
         */
    public static <T,S> ResponseEntity<DtoAndMsg<T>> getResponse(Function<S,T> function, S service) {
        try {
            ...
            return ResponseEntity.ok(new DtoAndMsg<>(e));
        }
    }
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D> ResponseEntity<DtoAndMsg<T>> getResponse(BiFunction<S,D,T> function, S service, D dto) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getResponse(FunctionInterfaces.ThreeParameterFunction<S,D1,D2,T> function, S service, D1 dto1, D2 dto2) {
        try {
            ...
            return ResponseEntity.ok(new DtoAndMsg<T>(e));
        }
    }
     ...
     * @return
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getResponse(FunctionInterfaces.FourParameterFunction<S,D1,D2,D3,T> function, S service, D1 dto1, D2 dto2, D3 dto3) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3,D4> ResponseEntity<DtoAndMsg<T>> getResponse(FunctionInterfaces.FiveParameterFunction<S,D1,D2,D3,D4,T> function, S service, D1 dto1, D2 dto2, D3 dto3, D4 dto4) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D> ResponseEntity<DtoAndMsg<T>> getErrResponse(BiFunction<S,D,T> function, S service, D dto) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getErrResponse(FunctionInterfaces.ThreeParameterFunction<S,D1,D2,T> function, S service, D1 dto1, D2 dto2) {
        try {
            T erg = function.apply(service, dto1, dto2);
     ...
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getErrResponse(
     ...
     * @return  Response-Entity mit MsgDto, das im Fehlerfall (Service-Funktion gibt Text zurück) gesetzt wird
     */
    public static <T,S,D1,D2,D3,D4> ResponseEntity<DtoAndMsg<T>> getErrResponse(
     ...
     * @return  Response-Entity mit MsgDto, das im Fehlerfall (Service-Funktion gibt Text zurück) gesetzt wird
     */
    public static <T,S,D1,D2,D3,D4,D5> ResponseEntity<DtoAndMsg<T>> getErrResponse(
    ...
    public static <T,S,D1,D2,D3,D4,D5,D6> ResponseEntity<DtoAndMsg<T>> getErrResponse(
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S> ResponseEntity<DtoAndMsg<T>> getRespData(Function<S,DtoAndMsg<T>> function, S service) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D> ResponseEntity<DtoAndMsg<T>> getRespData(BiFunction<S,D,DtoAndMsg<T>> function, S service, D dto) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getRespData(FunctionInterfaces.ThreeParameterFunction<S,D1,D2,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getRespData(FunctionInterfaces.FourParameterFunction<S,D1,D2,D3,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2, D3 dto3) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3,D4> ResponseEntity<DtoAndMsg<T>> getRespData(FunctionInterfaces.FiveParameterFunction<S,D1,D2,D3,D4,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2, D3 dto3, D4 dto4) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S> ResponseEntity<DtoAndMsg<T>> getRespErrData(Function<S,DtoAndMsg<T>> function, S service) {
        try {
            return ResponseEntity.ok(new DtoAndMsg<T>(DtoAndMsg.get(function.apply(service))));
        } catch (MsgException m) {
            return ResponseEntity.ok(new DtoAndMsg<T>(m.getMessage(), loadToken().getSprache()));
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D> ResponseEntity<DtoAndMsg<T>> getRespErrData(BiFunction<S,D,DtoAndMsg<T>> function, S service, D dto) {
        try {
     ...
     * @return      Response-Entity-Objekt mit eingepacktem DtoAndMsg-Objekt
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getRespErrData(FunctionInterfaces.ThreeParameterFunction<S,D1,D2,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3> ResponseEntity<DtoAndMsg<T>> getRespErrData(FunctionInterfaces.FourParameterFunction<S,D1,D2,D3,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2, D3 dto3) {
        try {
     ...
     * @return
     */
    public static <T,S,D1,D2,D3,D4> ResponseEntity<DtoAndMsg<T>> getRespErrData(FunctionInterfaces.FiveParameterFunction<S,D1,D2,D3,D4,DtoAndMsg<T>> function, S service, D1 dto1, D2 dto2, D3 dto3, D4 dto4) {
        try {
