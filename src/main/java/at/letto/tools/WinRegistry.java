 ...
 * @author http://stackoverflow.com/questions/62289/read-write-to-windows-registry-using-java
 *
 */
public class WinRegistry {
   ...
   * @throws IllegalAccessException Fehler
   * @throws InvocationTargetException Fehler
   */
