...
public class AjaxWelcomeInfo {
    ...
    private String htmlInfoMongoDocker="";
    private String htmlInfoRedisDocker="";
    private String revLettoMysql="";
    private String revLettoMongo="";
    private String revLettoRedis="";
    private String htmlInfoSetupDocker="";
    private String revSetupDocker="";
    private String htmlInfoProxyDocker="";
    private String revProxyDocker="";
    ...
    private String htmlInfoMongoDatabase="";
    private String htmlInfoRedisDatabase="";
